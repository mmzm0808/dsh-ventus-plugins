...
try { localStorage.setItem('dsh.ventus.localSha', "dcf711819e7a1a19718413cccb5fef58b897dd71") } catch {}
window.__ModuleLoader__.load({
  ...
  `;
    ...
    exports.inject = ["slots","sessions","connection","workspaces","locale","modules","settingsScope","conversationEvents","remote","layout"];
    exports.apply = (ctx) => {
