...
function apply(ctx) {
    ...
    disposeStyles = insertCss(`
      ...
      body.theme-endfield-surface-glass [class$='_sidebarCol'] [class*='_root'] {
        /* 毛玻璃质感：背后是纯黑页面背景（等高线花纹太暗透不出），
           玻璃感只能靠自身光学效果——顶部/左缘白色反光渐变模拟玻璃
           反光，底色用带蓝灰调的深色（非纯黑）38% 半透明，blur 磨砂。 */
        background:
          linear-gradient(180deg, rgba(255, 255, 255, 0.10), rgba(255, 255, 255, 0.03) 30%, transparent 55%),
          linear-gradient(90deg, rgba(255, 255, 255, 0.05), transparent 25%),
          color-mix(in srgb, #14171c 38%, transparent) !important;
